...
const (
	...
	MsgApplicationSubmitted  = "认养申请已提交，等待管理员审核"
	MsgApplicationWaitlisted = "该地块已有待审申请，已为您排入候补队列"
	MsgApplicationWithdrawn  = "认养申请已撤回"
	MsgApplicationApproved   = "认养申请已通过，地块认养成功"
	MsgApplicationRejected   = "认养申请已驳回"
